...
**REST / OpenAPI:** for non-MCP HTTP endpoints (`/api/*`), see **[OPENAPI.md](../OPENAPI.md)** — [Swagger UI](https://agentstack.tech/docs), [openapi.json](https://agentstack.tech/openapi.json).
