...
A single tool **agentstack.execute** with batched steps and **<!-- stats:total_actions -->463<!-- /stats:total_actions --> catalog actions** (see [MCP_SCALE.md](MCP_SCALE.md), [MCP_CAPABILITY_MATRIX.md](MCP_CAPABILITY_MATRIX.md)). One API, async jobs and streaming.
