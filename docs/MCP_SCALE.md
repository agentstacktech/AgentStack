...
**Snapshot (platform <!-- stats:platform_version -->0.4.18<!-- /stats:platform_version -->):** <!-- stats:total_actions -->568<!-- /stats:total_actions --> catalog actions · <!-- stats:mcp_domains -->48<!-- /stats:mcp_domains --> domains · see matrix header for regeneration date.
