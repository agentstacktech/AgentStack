...
**Snapshot (platform <!-- stats:platform_version -->0.4.15<!-- /stats:platform_version -->):** <!-- stats:total_actions -->494<!-- /stats:total_actions --> catalog actions · <!-- stats:mcp_domains -->45<!-- /stats:mcp_domains --> domains · see matrix header for regeneration date.
