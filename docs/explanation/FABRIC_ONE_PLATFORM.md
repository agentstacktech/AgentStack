...
**MCP** is the integrator remote: <!-- stats:total_actions -->568<!-- /stats:total_actions --> catalog actions, one `agentstack.execute` transport. **Compass** is the human remote: same capabilities as playbooks and comfort tasks.
